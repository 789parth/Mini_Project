...
public class productadapter extends FirebaseRecyclerAdapter<products, productadapter.myviewholder> {
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull products model) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            bundle.putString("image", model.getImagePath());
            bundle.putString("description", "This is a fresh and high-quality product."); // You can add description to your domain model
            bundle.putString("ingredients", "Natural, Organic"); // You can add ingredients to your domain model
            detailsBottomSheetFragment.setArguments(bundle);
            detailsBottomSheetFragment.show(((AppCompatActivity) v.getContext()).getSupportFragmentManager(), "DetailsBottomSheetFragment");
        });
    }
